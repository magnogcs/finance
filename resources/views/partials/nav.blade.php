	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="{{ route('index') }}">
				<img class="navbar-brand-image" alt="bdgt" src="/img/logo-white.png">
		...
		<div class="collapse navbar-collapse" id="primary-navbar">
			<ul class="nav navbar-nav">
				...
				<li class="{{ (strpos(request()->route()->getName(), 'goals') !== false ? 'active' : '') }}"><a href="{{ route('goals.index') }}">Metas</a></li>
				<li class="{{ (strpos(request()->route()->getName(), 'bills') !== false ? 'active' : '') }}"><a href="{{ route('bills.index') }}">Contas a pagar</a></li>
				<li class="dropdown {{ (strpos(request()->route()->getName(), 'reports') !== false ? 'active' : '') }}">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="/reports/categorial">Gastos por categoria</a></li>
						<li><a href="/reports/spending">Gastos totais</a></li>
					</ul>
				</li>
				@endif
				<li class="dropdown {{ (strpos(request()->route()->getName(), 'calculators') !== false ? 'active' : '') }}">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Calculadora<span class="caret"></span></a>
					<ul class="dropdown-menu" role="menu">
						<li><a href="{{ route('calculators.debt') }}">Calculadora de debto</a></li>
